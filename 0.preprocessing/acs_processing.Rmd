...
pluto <- read_csv("/Users/cpreeldumas/Desktop/NYU/SPRING 2023/ML for Cities/Project/pluto_23v1.csv") %>% 
  select(bbl, bct2020, ct2010, borough, tract2010)
```
...
acs_bbl <- acs_bbl_full %>% 
  select(bbl, tract_19, geo_name_19, tract_21, geo_name_21, 
...
acs_bbl %>% 
  ...
  write_csv("/Users/cpreeldumas/Documents/GitHub/MLC_SP23/clean_data/acs_bbl.csv")
